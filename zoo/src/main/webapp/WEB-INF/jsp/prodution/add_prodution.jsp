...
<div id="Insumosinformations">
				...
				<div>
					<label for="number">Quantidade total produzida:</label> <input
						type="number" class="form-control" id="qtd_final" name="qtd_final" required>
				</div>
