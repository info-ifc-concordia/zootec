		...
		<div id="caixa">
			...
			<div class="form-group col-md-6 col-xs-12">
				<label for="sel1">Destinado:</label> <select class="form-control"
					id="animal_type_ration" name="animal_type_ration" required>
			...
			<div class="form-group col-md-6 col-xs-12">
				<label for="text">Nome da ração:</label> <input type="text"
					class="form-control" name="name_ration" id="name_ration" required>
			</div>

			<!-- POR PADRÃO, INCIALMENTE DEFINIREMOS COMO POSSÍVEL ADICIONAR 11 TIPOS DE INSUMOS DIFERENTES -->
			<!--  					
						<div class="form-group col-md-4 col-xs-12">
						    <label for="number">Quantidade de insumos:</label>
						    <input type="number" class="form-control" id="qtdInsumos" min=1 max=50>
						</div>-->


			<!--
						<div id="insumosColocar">
